...
class Scene2_1_NeedForRanking(Scene):
    ...
    def construct(self):
        ...
        self.play(FadeIn(uscf_sub, shift=UP * 0.2), run_time=0.5)
        ...
        self.play(FadeIn(intro_box), Write(intro_text, run_time=1.2))
        self.wait(2)
...
class Scene2_2_LinearMechanics(Scene):
    ...
    def construct(self):
        ...
        self.play(
            FadeIn(box_high), FadeIn(high_label), Write(formula_high, run_time=1),
            run_time=1.2
        )
        self.play(
            FadeIn(box_low), FadeIn(low_label), Write(formula_low, run_time=1),
            run_time=1.2
        )
        ...
        self.play(Create(linear_line), run_time=1)
        ...
        for x_val, label_str, col in [(-500, "0%", ELO_RED), (0, "50%", TEXT_GRAY), (500, "100%", ELO_GREEN)]:
            ...
            ann.next_to(dot, UP, buff=0.1)
            self.play(FadeIn(dot), FadeIn(ann), run_time=0.3)

        self.wait(2)
        self.play(*[FadeOut(mob) for mob in self.mobjects], run_time=0.8)


class Scene2_3_LosingWinnerParadox(Scene):
    ...
    def construct(self):
        ...
        self.play(FadeIn(scenario_box), Write(scenario_title), run_time=0.6)
        self.play(
        ...
        self.play(FadeIn(calc_box), Write(calc_title), run_time=0.6)
        ...
        self.play(Indicate(calc_steps[-1], color=ELO_RED, scale_factor=1.1), run_time=0.6)
...
class Scene2_4_EliteNotProtected(Scene):
    ...
    def construct(self):
        ...
        self.play(FadeIn(before_bar), FadeIn(before_label), FadeIn(before_title), run_time=0.5)
        self.play(FadeIn(after_bar), FadeIn(after_label), FadeIn(after_title),
...
class Scene2_5_NeedForProbability(Scene):
    ...
    def construct(self):
        ...
        self.play(Create(linear_graph), FadeIn(linear_label), run_time=1.2)
        self.wait(0.8)
        ...
        self.play(Create(prob_graph), FadeIn(prob_label), run_time=1.2)
        ...
        self.play(FadeIn(bad_dot), FadeIn(good_dot), run_time=0.5)
        self.play(FadeIn(bad_ann), FadeIn(good_ann), run_time=0.8)
